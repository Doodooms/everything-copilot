# AGENTS.md — everything-copilot

> **Read this file first.** It is the navigation map for every AI agent working in this repository.

## Project

**everything-copilot** — GitHub Copilot-first workflow workspace with AHK orchestration, GitNexus impact analysis, and Graphify semantic memory.
...
docs.search          query                                  → search ./.github for relevant content
```
